import { A as AstroError, c as InvalidImageService, d as ExpectedImageOptions, E as ExpectedImage, F as FailedToFetchRemoteImageDimensions, e as createAstro, f as createComponent, g as ImageMissingAlt, r as renderTemplate, m as maybeRenderHead, h as addAttribute, s as spreadAttributes, i as defineScriptVars, j as renderComponent, k as renderHead, l as renderSlot } from '../astro_BEI0rHQ5.mjs';
import 'kleur/colors';
import 'clsx';
/* empty css                       */
import { i as isRemoteImage, a as isESMImportedImage, b as isLocalService, D as DEFAULT_HASH_PROPS } from '../astro/assets-service_D_yEmZ--.mjs';
...
async function getConfiguredImageService() {
  if (!globalThis?.astroAsset?.imageService) {
    const { default: service } = await import(
      // @ts-expect-error
      '../astro/assets-service_D_yEmZ--.mjs'
    ).then(n => n.g).catch((e) => {
...
}, "/Users/manueljesusreeb/Documents/astrofy-main/profile/node_modules/astro/components/Image.astro", void 0);
...
}, "/Users/manueljesusreeb/Documents/astrofy-main/profile/node_modules/astro/components/Picture.astro", void 0);

const imageConfig = {"service":{"entrypoint":"astro/assets/services/sharp","config":{}},"domains":[],"remotePatterns":[]};
					const outDir = new URL("file:///Users/manueljesusreeb/Documents/astrofy-main/profile/.vercel/output/static/");
...
&copy; ${today.getFullYear()} Manuel jesus Reeb
</div> <div class="inline opacity-75">
Developed by <a href="https://manuelernestog.github.io" target="_blank" class="font-bold">Manuel Jesus Reeb</a> using
...
const $$SideBarMenu = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate(_a || (_a = __template(["", '<ul class="menu grow shrink menu-md overflow-y-auto"> <li><a class="py-3 text-base" id="home" href="/">Home</a></li> <li><a class="py-3 text-base" id="projects" href="/projects">Projects</a></li> <!-- <li><a class="py-3 text-base" id="services" href="/services">Services</a></li> --> <!-- <li><a class="py-3 text-base" id="store" href="/store">Store</a></li> --> <!-- <li><a class="py-3 text-base" id="blog" href="/blog/">Blog</a></li> --> <li><a class="py-3 text-base" id="cv" href="/cv">CV</a></li> <li> <a class="py-3 text-base" href="mailto:jesusseep@gmail.com" target="_blank" referrerpolicy="no-referrer-when-downgrade">Contact</a> </li> </ul> <script>(function(){', "\nconst activeItemElem = document.getElementById(sideBarActiveItemID);\nactiveItemElem && activeItemElem.classList.add(activeClass);\n})();<\/script>"])), maybeRenderHead(), defineScriptVars({ sideBarActiveItemID, activeClass }));
}, "/Users/manueljesusreeb/Documents/astrofy-main/profile/src/components/SideBarMenu.astro", void 0);
...
}, "/Users/manueljesusreeb/Documents/astrofy-main/profile/src/components/SideBar.astro", void 0);
...
}, "/Users/manueljesusreeb/Documents/astrofy-main/profile/node_modules/astro/components/ViewTransitions.astro", void 0);
...
}, "/Users/manueljesusreeb/Documents/astrofy-main/profile/src/layouts/BaseLayout.astro", void 0);
...
}, "/Users/manueljesusreeb/Documents/astrofy-main/profile/src/pages/404.astro", void 0);

const $$file = "/Users/manueljesusreeb/Documents/astrofy-main/profile/src/pages/404.astro";
const $$url = "/404";
